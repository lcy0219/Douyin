...
public class CodeGeneration {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/douyin?useUnicode=true&characterEncoding=utf-8&useSSL=false","root","123456")
         ...
         * 全局配置
         */
        String projectPath = "C:\\Users\\project\\douyin"; //获取项目路径
        String filePath = projectPath + "/src/main";  //java下的文件路径
        GlobalConfig global = new GlobalConfig.Builder()
                .outputDir(filePath)//生成的输出路径
                .author("chenyuan")//生成的作者名字
